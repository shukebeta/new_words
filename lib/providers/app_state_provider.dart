...
class AppStateProvider with ChangeNotifier {
  ...
  void _initializeAuthState() {
    ...
    debugPrint('AppStateProvider: Initializing auth state - isAuthenticated: $isAuthenticated');
  ...
  bool get allProvidersInitialized => _authAwareProviders.every(
    (provider) => provider.isAuthStateInitialized || !_authProvider.isAuthenticated
  );
