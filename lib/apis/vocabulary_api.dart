...
class VocabularyApi {
  ...
  Future<Response> addWord(AddWordRequest request) async {
    return await _dio.post('/vocabulary/add', data: request.toJson());
  }
  ...
  Future<Response> deleteWord(int wordId) async {
    return await _dio.delete('/vocabulary/delete/$wordId');
  }
  ...
  Future<Response> getMemories(String localTimezone) async {
    return await _dio.get(
      '/vocabulary/Memories',
      queryParameters: {'localTimezone': localTimezone},
    );
  }

  Future<Response> getMemoriesOnDate(
    String localTimezone,
    String yyyyMMdd,
  ) async {
    return await _dio.get(
      '/vocabulary/MemoriesOn',
      queryParameters: {'localTimezone': localTimezone, 'yyyyMMdd': yyyyMMdd},
    );
  }
}
